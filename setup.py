...
class BuildRDKit(build_ext_orig):
    ...
    def build_boost(self, ext):
        ...
        if sys.platform == 'win32':
            ...
            f'./b2 install --with-python --with-serialization --with-iostreams --with-system --with-regex --prefix={boost_install_path} -j 20 -s ZLIB_SOURCE="C:\\PROGRA~1\\zlib" -s ZLIB_INCLUDE="C:\\PROGRA~1\\zlib\\include"',
         ]
